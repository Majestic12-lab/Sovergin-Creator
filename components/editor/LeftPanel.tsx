  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginTop: '8px' }}>
          {VOICES.map((v) => {
            ...
            return (
              ...
              >
                <p style={{ color: selected ? '#7F77DD' : '#fff', fontSize: '13px', fontWeight: 600, margin: 0 }}>
                  {v.label}
                </p>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginTop: '8px' }}>
          {THEMES.map((theme) => {
            ...
            return (
              <button
                key={theme}
                onClick={() => setBackgroundTheme(themeId)}
                style={{
      ...
      <div style={{ marginTop: 'auto' }}>
        ...
        {error && (
          <p style={{ fontSize: '12px', color: '#ff6b6b', marginBottom: '8px' }}>{error}</p>
        )}
