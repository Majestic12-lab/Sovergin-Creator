      ...
      <section>
        ...
        <div style={{ marginTop: '12px' }}>
          <input
            ...
            placeholder="Paste direct video URL (.mp4, .mov, .webm)"
            style={{
              width: '100%',
          ...
          <p style={{ fontSize: '11px', color: '#555', marginTop: '6px', lineHeight: 1.5 }}>
            Tip: Use{' '}
            <a href="https://cobalt.tools" target="_blank" rel="noopener noreferrer" style={{ color: '#7F77DD', textDecoration: 'none' }}>
              cobalt.tools
            </a>
            {' '}to convert YouTube links to direct MP4 URLs
          </p>
